...
const catalog = {
  en: {
    "meta.description": "Full Stack Engineer building complete web products, APIs, SaaS platforms, and scalable architecture. Available for remote contracts.",
    ...
    "hero.focus": "Full stack • APIs • Product systems",
    "hero.role": "Full Stack Engineer",
    "hero.headline": "Full Stack Engineer — complete products, APIs & scalable architecture.",
    "hero.summary": "I build complete web products, APIs, microservices platforms, and production SaaS systems for startups and businesses. Based in Dominican Republic, available for remote contracts globally.",
    ...
    "hero.metric.focusValue": "Full stack",
    ...
    "projects.subtitle": "Web products, fintech APIs, microservices platforms, and multi-tenant SaaS work built around real product and architecture decisions.",
    ...
    "about.title": "Full-stack product engineering from Santo Domingo.",
    ...
    "contact.subtitle": "I'm available for full-stack product work, APIs, SaaS platforms, automation, and technical consulting. Response within 24-48 hours.",
    "contact.email": "Email",
  ...
  de: {
    "meta.description": "Full Stack Engineer für komplette Webprodukte, APIs, SaaS-Plattformen und skalierbare Architektur. Verfügbar für Remote-Aufträge.", "nav.projects": "Projekte", "nav.caseStudies": "Fallstudien", "nav.about": "Über mich", "nav.contact": "Kontakt", "nav.resume": "Lebenslauf", "nav.inquiry": "Anfrage", "nav.language": "Sprache", "a11y.title": "Barrierefreiheit", "a11y.open": "Barrierefreiheit öffnen", "a11y.close": "Schließen", "a11y.largeText": "Größerer Text", "a11y.highContrast": "Hoher Kontrast", "a11y.reduceMotion": "Bewegung reduzieren",
    "hero.availability": "Verfügbar für Remote-Aufträge", "hero.focus": "Full Stack • APIs • Produktsysteme", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — komplette Produkte, APIs & skalierbare Architektur.", "hero.summary": "Ich baue komplette Webprodukte, APIs, Microservices-Plattformen und produktive SaaS-Systeme für Startups und Unternehmen. In der Dominikanischen Republik ansässig, weltweit remote verfügbar.", "hero.primary": "Meine Arbeit ansehen", "hero.secondary": "Zusammenarbeiten", "hero.search": "Projekte, Architektur, Fähigkeiten suchen...",
    "hero.metric.focusLabel": "Schwerpunkt", "hero.metric.focusValue": "Full Stack", "hero.metric.locationLabel": "Standort", "hero.metric.locationValue": "Remote", "hero.metric.availabilityLabel": "Verfügbarkeit", "hero.metric.availabilityValue": "Verträge",
    "projects.eyebrow": "Ausgewählte Arbeit", "projects.title": "Produktionssysteme, kein Portfolio-Theater.", "projects.subtitle": "Webprodukte, Fintech-APIs, Microservices-Plattformen und Multi-Tenant-SaaS mit echten Produkt- und Architekturentscheidungen.", "projects.keyStats": "Kennzahlen", "projects.architecture": "Architekturentscheidung", "projects.private": "Privates Produktionssystem",
    ...
    "about.eyebrow": "Über mich", "about.title": "Full-Stack-Produktentwicklung aus Santo Domingo.", "about.body1": "Ich bin Teudy, ein autodidaktischer Full Stack Engineer aus Santo Domingo und habe kürzlich meinen Abschluss am ITLA gemacht. Ich arbeite über den gesamten Stack hinweg: Interfaces, APIs, Microservices, Cloud-Infrastruktur und Produktabläufe.", "about.body2": "Ich habe Teams geleitet, praktische Lösungen für technische Probleme gefunden, verteilte Architekturen entworfen und Systeme gebaut, die echtes Geld und echte Nutzer verarbeiten. Ich bin für Remote-Aufträge in den USA, Kanada und Europa verfügbar.", "about.personal": "Außerhalb des Codes spiele ich Klavier und entwickle Videospiele.", "about.email": "E-Mail",
    "contact.eyebrow": "Kontakt", "contact.title": "Haben Sie ein Projekt? Sprechen wir.", "contact.subtitle": "Ich bin verfügbar für Full-Stack-Produkte, APIs, SaaS-Plattformen, Automatisierung und technische Beratung. Antwort innerhalb von 24-48 Stunden.", "contact.email": "E-Mail", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "Lebenslauf", "contact.downloadCv": "CV herunterladen", "contact.location": "Standort", "contact.locationValue": "Santo Domingo, Dominikanische Republik — weltweit remote verfügbar", "contact.name": "Name", "contact.namePlaceholder": "Ihr Name", "contact.emailPlaceholder": "sie@example.com", "contact.projectDescription": "Projektbeschreibung", "contact.projectPlaceholder": "Beschreiben Sie das System, die API, das Produkt oder den Beratungsbedarf.", "contact.remote": "Remote-Verträge", "contact.send": "Anfrage senden",
  },
  it: {
    "meta.description": "Full Stack Engineer per prodotti web completi, API, piattaforme SaaS e architetture scalabili. Disponibile per contratti da remoto.", "nav.projects": "Progetti", "nav.caseStudies": "Casi studio", "nav.about": "Profilo", "nav.contact": "Contatto", "nav.resume": "CV", "nav.inquiry": "Richiesta", "nav.language": "Lingua", "a11y.title": "Accessibilità", "a11y.open": "Apri opzioni di accessibilità", "a11y.close": "Chiudi", "a11y.largeText": "Testo grande", "a11y.highContrast": "Contrasto alto", "a11y.reduceMotion": "Riduci movimento",
    "hero.availability": "Disponibile per contratti da remoto", "hero.focus": "Full stack • API • prodotti digitali", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — prodotti completi, API e architetture scalabili.", "hero.summary": "Costruisco prodotti web completi, API, piattaforme a microservizi e sistemi SaaS in produzione per startup e aziende. Basato nella Repubblica Dominicana, disponibile da remoto a livello globale.", "hero.primary": "Vedi i progetti", "hero.secondary": "Lavoriamo insieme", "hero.search": "Cerca progetti, architettura, competenze...",
    "hero.metric.focusLabel": "Focus", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Modalità", "hero.metric.locationValue": "Remoto", "hero.metric.availabilityLabel": "Disponibilità", "hero.metric.availabilityValue": "Contratti",
    "projects.eyebrow": "Lavori selezionati", "projects.title": "Sistemi reali, non vetrina.", "projects.subtitle": "Prodotti web, API fintech, piattaforme a microservizi e SaaS multi-tenant costruiti attorno a vere decisioni di prodotto e architettura.", "projects.keyStats": "Dati chiave", "projects.architecture": "Scelta architetturale", "projects.private": "Sistema di produzione privato",
    ...
    "about.eyebrow": "Profilo", "about.title": "Product engineering full stack da Santo Domingo.", "about.body1": "Sono Teudy, Full Stack Engineer autodidatta basato a Santo Domingo, e mi sono appena laureato all'ITLA. Lavoro su tutto lo stack: interfacce, API, microservizi, infrastruttura cloud e flussi di prodotto.", "about.body2": "Ho guidato team, trovato soluzioni pratiche a problemi tecnici, progettato architetture distribuite e costruito sistemi con denaro e utenti reali. Sono disponibile per contratti remoti con aziende in USA, Canada ed Europa.", "about.personal": "Fuori dal codice, suono il pianoforte e sviluppo videogiochi.", "about.email": "Email",
    "contact.eyebrow": "Contatto", "contact.title": "Hai un progetto? Parliamone.", "contact.subtitle": "Sono disponibile per prodotti full stack, API, piattaforme SaaS, automazione e consulenza tecnica. Risposta entro 24-48 ore.", "contact.email": "Email", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "CV", "contact.downloadCv": "Scarica CV", "contact.location": "Posizione", "contact.locationValue": "Santo Domingo, Repubblica Dominicana — disponibile globalmente da remoto", "contact.name": "Nome", "contact.namePlaceholder": "Il tuo nome", "contact.emailPlaceholder": "tu@example.com", "contact.projectDescription": "Descrizione del progetto", "contact.projectPlaceholder": "Descrivi il sistema, l'API, il prodotto o la consulenza richiesta.", "contact.remote": "Contratti remoti", "contact.send": "Invia richiesta",
  },
  pt: {
    "meta.description": "Full Stack Engineer criando produtos web completos, APIs, plataformas SaaS e arquitetura escalável. Disponível para contratos remotos.", "nav.projects": "Projetos", "nav.caseStudies": "Estudos de caso", "nav.about": "Sobre", "nav.contact": "Contato", "nav.resume": "Currículo", "nav.inquiry": "Contato", "nav.language": "Idioma", "a11y.title": "Acessibilidade", "a11y.open": "Abrir opções de acessibilidade", "a11y.close": "Fechar", "a11y.largeText": "Texto maior", "a11y.highContrast": "Alto contraste", "a11y.reduceMotion": "Reduzir movimento",
    "hero.availability": "Disponível para contratos remotos", "hero.focus": "Full stack • APIs • produtos digitais", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — produtos completos, APIs e arquitetura escalável.", "hero.summary": "Construo produtos web completos, APIs, plataformas de microsserviços e sistemas SaaS em produção para startups e empresas. Baseado na República Dominicana, disponível globalmente de forma remota.", "hero.primary": "Ver meu trabalho", "hero.secondary": "Vamos trabalhar juntos", "hero.search": "Buscar projetos, arquitetura, capacidades...",
    "hero.metric.focusLabel": "Foco", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Local", "hero.metric.locationValue": "Remoto", "hero.metric.availabilityLabel": "Disponibilidade", "hero.metric.availabilityValue": "Contratos",
    "projects.eyebrow": "Trabalho selecionado", "projects.title": "Sistemas de produção, não vitrine.", "projects.subtitle": "Produtos web, APIs fintech, plataformas de microsserviços e SaaS multi-tenant construídos com decisões reais de produto e arquitetura.", "projects.keyStats": "Dados principais", "projects.architecture": "Escolha de arquitetura", "projects.private": "Sistema privado em produção",
    ...
    "about.eyebrow": "Sobre mim", "about.title": "Engenharia de produto full stack desde Santo Domingo.", "about.body1": "Sou Teudy, Full Stack Engineer autodidata baseado em Santo Domingo, e me formei recentemente no ITLA. Trabalho em todo o stack: interfaces, APIs, microsserviços, infraestrutura em nuvem e fluxos de produto.", "about.body2": "Liderei equipes, encontrei soluções práticas para problemas técnicos, desenhei arquiteturas distribuídas e construí sistemas com dinheiro e usuários reais. Estou disponível para contratos remotos com empresas dos EUA, Canadá e Europa.", "about.personal": "Fora do código, eu toco piano e desenvolvo videogames.", "about.email": "Email",
    "contact.eyebrow": "Contato", "contact.title": "Tem um projeto? Vamos conversar.", "contact.subtitle": "Estou disponível para produtos full stack, APIs, plataformas SaaS, automação e consultoria técnica. Resposta em 24-48 horas.", "contact.email": "Email", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "Currículo", "contact.downloadCv": "Baixar CV", "contact.location": "Localização", "contact.locationValue": "Santo Domingo, República Dominicana — disponível globalmente remoto", "contact.name": "Nome", "contact.namePlaceholder": "Seu nome", "contact.emailPlaceholder": "voce@example.com", "contact.projectDescription": "Descrição do projeto", "contact.projectPlaceholder": "Descreva o sistema, API, produto ou necessidade de consultoria.", "contact.remote": "Contratos remotos", "contact.send": "Enviar contato",
  },
  es: {
    "meta.description": "Full Stack Engineer creando productos web completos, APIs, plataformas SaaS y arquitectura escalable. Disponible para contratos remotos.", "nav.projects": "Proyectos", "nav.caseStudies": "Casos de estudio", "nav.about": "Sobre mí", "nav.contact": "Contacto", "nav.resume": "CV", "nav.inquiry": "Consulta", "nav.language": "Idioma", "a11y.title": "Accesibilidad", "a11y.open": "Abrir opciones de accesibilidad", "a11y.close": "Cerrar", "a11y.largeText": "Texto grande", "a11y.highContrast": "Alto contraste", "a11y.reduceMotion": "Reducir movimiento",
    "hero.availability": "Disponible para contratos remotos", "hero.focus": "Full stack • APIs • productos digitales", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — productos completos, APIs y arquitectura escalable.", "hero.summary": "Construyo productos web completos, APIs, plataformas de microservicios y sistemas SaaS en producción para startups y empresas. Basado en República Dominicana, disponible para contratos remotos globalmente.", "hero.primary": "Ver mi trabajo", "hero.secondary": "Trabajemos juntos", "hero.search": "Buscar proyectos, arquitectura, capacidades...",
    "hero.metric.focusLabel": "Enfoque", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Ubicación", "hero.metric.locationValue": "Remoto", "hero.metric.availabilityLabel": "Disponibilidad", "hero.metric.availabilityValue": "Contratos",
    "projects.eyebrow": "Trabajo seleccionado", "projects.title": "Sistemas en producción, no teatro de portafolio.", "projects.subtitle": "Productos web, APIs fintech, plataformas de microservicios y SaaS multi-tenant construidos con decisiones reales de producto y arquitectura.", "projects.keyStats": "Datos clave", "projects.architecture": "Decisión de arquitectura", "projects.private": "Sistema privado en producción",
    ...
    "about.eyebrow": "Sobre mí", "about.title": "Ingeniería de producto full stack desde Santo Domingo.", "about.body1": "Soy Teudy, Full Stack Engineer autodidacta basado en Santo Domingo, República Dominicana, y recientemente me gradué de ITLA. Trabajo en todo el stack: interfaces, APIs, microservicios, infraestructura cloud y flujos de producto.", "about.body2": "He liderado equipos, encontrado soluciones prácticas a problemas técnicos, diseñado arquitecturas distribuidas y construido sistemas que manejan dinero real y usuarios reales. Estoy disponible para contratos remotos con startups y empresas en Estados Unidos, Canadá y Europa.", "about.personal": "Fuera del código, toco piano y desarrollo videojuegos.", "about.email": "Email",
    "contact.eyebrow": "Contacto", "contact.title": "¿Tienes un proyecto? Hablemos.", "contact.subtitle": "Estoy disponible para productos full stack, APIs, plataformas SaaS, automatización y consultoría técnica. Respondo en 24-48 horas.", "contact.email": "Email", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "CV", "contact.downloadCv": "Descargar CV", "contact.location": "Ubicación", "contact.locationValue": "Santo Domingo, República Dominicana — disponible globalmente remoto", "contact.name": "Nombre", "contact.namePlaceholder": "Tu nombre", "contact.emailPlaceholder": "tu@example.com", "contact.projectDescription": "Descripción del proyecto", "contact.projectPlaceholder": "Cuéntame sobre el sistema, API, producto o necesidad de consultoría.", "contact.remote": "Contratos remotos", "contact.send": "Enviar consulta",
  },
  no: {
    "meta.description": "Full Stack Engineer som bygger komplette webprodukter, API-er, SaaS-plattformer og skalerbar arkitektur. Tilgjengelig for fjernkontrakter.", "nav.projects": "Prosjekter", "nav.caseStudies": "Casestudier", "nav.about": "Om meg", "nav.contact": "Kontakt", "nav.resume": "CV", "nav.inquiry": "Forespørsel", "nav.language": "Språk", "a11y.title": "Tilgjengelighet", "a11y.open": "Åpne tilgjengelighetsvalg", "a11y.close": "Lukk", "a11y.largeText": "Større tekst", "a11y.highContrast": "Høy kontrast", "a11y.reduceMotion": "Reduser bevegelse",
    "hero.availability": "Tilgjengelig for fjernkontrakter", "hero.focus": "Full stack • API-er • produktsystemer", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — komplette produkter, API-er og skalerbar arkitektur.", "hero.summary": "Jeg bygger komplette webprodukter, API-er, mikrotjenesteplattformer og produksjonsklare SaaS-systemer for startups og bedrifter. Basert i Den dominikanske republikk, tilgjengelig globalt via fjernarbeid.", "hero.primary": "Se arbeidet mitt", "hero.secondary": "La oss jobbe sammen", "hero.search": "Søk i prosjekter, arkitektur og kompetanse...",
    "hero.metric.focusLabel": "Hovedfokus", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Arbeidsform", "hero.metric.locationValue": "Fjernarbeid", "hero.metric.availabilityLabel": "Tilgjengelighet", "hero.metric.availabilityValue": "Kontrakter",
    ...
    "about.eyebrow": "Om meg", "about.title": "Fullstack produktutvikling fra Santo Domingo.", "about.body1": "Jeg er Teudy, en selvlært Full Stack Engineer basert i Santo Domingo, og jeg ble nylig uteksaminert fra ITLA. Jeg jobber på tvers av hele stacken: grensesnitt, API-er, mikrotjenester, skyinfrastruktur og produktflyt.", "about.body2": "Jeg har ledet team, funnet praktiske løsninger på tekniske problemer, designet distribuerte arkitekturer og bygget systemer som håndterer ekte penger og ekte brukere. Jeg er tilgjengelig for fjernkontrakter med selskaper i USA, Canada og Europa.", "about.personal": "Utenfor kode spiller jeg piano og utvikler videospill.", "about.email": "E-post",
    "contact.eyebrow": "Kontakt", "contact.title": "Har du et prosjekt? La oss snakke.", "contact.subtitle": "Jeg er tilgjengelig for fullstack-produkter, API-er, SaaS-plattformer, automasjon og teknisk rådgivning. Svar innen 24-48 timer.", "contact.email": "E-post", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "CV", "contact.downloadCv": "Last ned CV", "contact.location": "Sted", "contact.locationValue": "Santo Domingo, Den dominikanske republikk — tilgjengelig globalt via fjernarbeid", "contact.name": "Navn", "contact.namePlaceholder": "Navnet ditt", "contact.emailPlaceholder": "du@example.com", "contact.projectDescription": "Prosjektbeskrivelse", "contact.projectPlaceholder": "Fortell om systemet, API-et, produktet eller rådgivningsbehovet.", "contact.remote": "Fjernkontrakter", "contact.send": "Send forespørsel",
  },
  da: {
    "meta.description": "Full Stack Engineer der bygger komplette webprodukter, API'er, SaaS-platforme og skalerbar arkitektur. Tilgængelig for remote kontrakter.", "nav.projects": "Projekter", "nav.caseStudies": "Cases", "nav.about": "Om mig", "nav.contact": "Kontakt", "nav.resume": "CV", "nav.inquiry": "Forespørgsel", "nav.language": "Sprog", "a11y.title": "Tilgængelighed", "a11y.open": "Åbn tilgængelighedsvalg", "a11y.close": "Luk", "a11y.largeText": "Større tekst", "a11y.highContrast": "Høj kontrast", "a11y.reduceMotion": "Reducer bevægelse",
    "hero.availability": "Tilgængelig for remote kontrakter", "hero.focus": "Full stack • API'er • produktsystemer", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — komplette produkter, API'er og skalerbar arkitektur.", "hero.summary": "Jeg bygger komplette webprodukter, API'er, microservice-platforme og produktionsklare SaaS-systemer for startups og virksomheder. Baseret i Den Dominikanske Republik, tilgængelig globalt remote.", "hero.primary": "Se mit arbejde", "hero.secondary": "Lad os arbejde sammen", "hero.search": "Søg i projekter, arkitektur og kompetencer...",
    "hero.metric.focusLabel": "Primært fokus", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Arbejdsform", "hero.metric.locationValue": "Remote", "hero.metric.availabilityLabel": "Tilgængelighed", "hero.metric.availabilityValue": "Kontrakter",
    ...
    "about.eyebrow": "Om mig", "about.title": "Fullstack produktudvikling fra Santo Domingo.", "about.body1": "Jeg er Teudy, en selvlært Full Stack Engineer baseret i Santo Domingo, og jeg er for nylig dimitteret fra ITLA. Jeg arbejder på tværs af hele stacken: interfaces, API'er, microservices, cloud-infrastruktur og produktflows.", "about.body2": "Jeg har ledet teams, fundet praktiske løsninger på tekniske problemer, designet distribuerede arkitekturer og bygget systemer med rigtige penge og rigtige brugere. Jeg er tilgængelig for remote kontrakter med virksomheder i USA, Canada og Europa.", "about.personal": "Uden for kode spiller jeg klaver og udvikler videospil.", "about.email": "Email",
    "contact.eyebrow": "Kontakt", "contact.title": "Har du et projekt? Lad os tale.", "contact.subtitle": "Jeg er tilgængelig for fullstack-produkter, API'er, SaaS-platforme, automatisering og teknisk rådgivning. Svar inden for 24-48 timer.", "contact.email": "Email", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "CV", "contact.downloadCv": "Download CV", "contact.location": "Lokation", "contact.locationValue": "Santo Domingo, Den Dominikanske Republik — tilgængelig globalt remote", "contact.name": "Navn", "contact.namePlaceholder": "Dit navn", "contact.emailPlaceholder": "dig@example.com", "contact.projectDescription": "Projektbeskrivelse", "contact.projectPlaceholder": "Fortæl om systemet, API'et, produktet eller rådgivningsbehovet.", "contact.remote": "Remote kontrakter", "contact.send": "Send forespørgsel",
  },
  sv: {
    "meta.description": "Full Stack Engineer som bygger kompletta webbprodukter, API:er, SaaS-plattformar och skalbar arkitektur. Tillgänglig för distanskontrakt.", "nav.projects": "Projekt", "nav.caseStudies": "Fallstudier", "nav.about": "Om mig", "nav.contact": "Kontakt", "nav.resume": "CV", "nav.inquiry": "Förfrågan", "nav.language": "Språk", "a11y.title": "Tillgänglighet", "a11y.open": "Öppna tillgänglighetsval", "a11y.close": "Stäng", "a11y.largeText": "Större text", "a11y.highContrast": "Hög kontrast", "a11y.reduceMotion": "Minska rörelse",
    "hero.availability": "Tillgänglig för distanskontrakt", "hero.focus": "Full stack • API:er • produktsystem", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — kompletta produkter, API:er och skalbar arkitektur.", "hero.summary": "Jag bygger kompletta webbprodukter, API:er, mikrotjänstplattformar och produktionsklara SaaS-system för startups och företag. Baserad i Dominikanska republiken, tillgänglig globalt på distans.", "hero.primary": "Se mitt arbete", "hero.secondary": "Låt oss arbeta tillsammans", "hero.search": "Sök projekt, arkitektur och kompetenser...",
    "hero.metric.focusLabel": "Huvudfokus", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Arbetssätt", "hero.metric.locationValue": "Distans", "hero.metric.availabilityLabel": "Tillgänglighet", "hero.metric.availabilityValue": "Kontrakt",
    ...
    "about.eyebrow": "Om mig", "about.title": "Fullstack produktutveckling från Santo Domingo.", "about.body1": "Jag är Teudy, en självlärd Full Stack Engineer baserad i Santo Domingo, och jag tog nyligen examen från ITLA. Jag arbetar över hela stacken: gränssnitt, API:er, mikrotjänster, molninfrastruktur och produktflöden.", "about.body2": "Jag har lett team, hittat praktiska lösningar på tekniska problem, designat distribuerade arkitekturer och byggt system som hanterar riktiga pengar och riktiga användare. Jag är tillgänglig för distanskontrakt med företag i USA, Kanada och Europa.", "about.personal": "Utanför kod spelar jag piano och utvecklar videospel.", "about.email": "E-post",
    "contact.eyebrow": "Kontakt", "contact.title": "Har du ett projekt? Låt oss prata.", "contact.subtitle": "Jag är tillgänglig för fullstack-produkter, API:er, SaaS-plattformar, automatisering och teknisk rådgivning. Svar inom 24-48 timmar.", "contact.email": "E-post", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "CV", "contact.downloadCv": "Ladda ner CV", "contact.location": "Plats", "contact.locationValue": "Santo Domingo, Dominikanska republiken — tillgänglig globalt på distans", "contact.name": "Namn", "contact.namePlaceholder": "Ditt namn", "contact.emailPlaceholder": "du@example.com", "contact.projectDescription": "Projektbeskrivning", "contact.projectPlaceholder": "Berätta om systemet, API:et, produkten eller rådgivningsbehovet.", "contact.remote": "Distanskontrakt", "contact.send": "Skicka förfrågan",
  },
  is: {
    "meta.description": "Full Stack Engineer sem byggir heildstæðar vefvörur, API, SaaS-palla og skalanlegan arkitektúr. Laus í fjarvinnuverkefni.", "nav.projects": "Verkefni", "nav.caseStudies": "Dæmisögur", "nav.about": "Um mig", "nav.contact": "Hafa samband", "nav.resume": "Ferilskrá", "nav.inquiry": "Fyrirspurn", "nav.language": "Tungumál", "a11y.title": "Aðgengi", "a11y.open": "Opna aðgengisvalkosti", "a11y.close": "Loka", "a11y.largeText": "Stærri texti", "a11y.highContrast": "Mikill birtuskil", "a11y.reduceMotion": "Minnka hreyfingu",
    "hero.availability": "Laus í fjarvinnuverkefni", "hero.focus": "Full stack • API • vörukerfi", "hero.role": "Full Stack Engineer", "hero.headline": "Full Stack Engineer — heildstæðar vörur, API og skalanlegur arkitektúr.", "hero.summary": "Ég byggi heildstæðar vefvörur, API, microservices-palla og SaaS-kerfi í framleiðslu fyrir sprotafyrirtæki og fyrirtæki. Staðsettur í Dóminíska lýðveldinu og laus í fjarvinnuverkefni á heimsvísu.", "hero.primary": "Sjá verkefnin mín", "hero.secondary": "Vinnum saman", "hero.search": "Leita í verkefnum, arkitektúr og hæfni...",
    "hero.metric.focusLabel": "Aðalfókus", "hero.metric.focusValue": "Full stack", "hero.metric.locationLabel": "Vinnulag", "hero.metric.locationValue": "Fjarvinna", "hero.metric.availabilityLabel": "Laus", "hero.metric.availabilityValue": "Samningar",
    ...
    "about.eyebrow": "Um mig", "about.title": "Fullstack vöruþróun frá Santo Domingo.", "about.body1": "Ég er Teudy, sjálfmenntaður Full Stack Engineer staðsettur í Santo Domingo, og ég útskrifaðist nýlega frá ITLA. Ég vinn yfir allan stackinn: viðmót, API, microservices, skýjainnviði og vöruflæði.", "about.body2": "Ég hef leitt teymi, fundið hagnýtar lausnir á tæknilegum vandamálum, hannað dreifðan arkitektúr og byggt kerfi sem vinna með alvöru peninga og alvöru notendur. Ég er laus í fjarvinnuverkefni með fyrirtækjum í Bandaríkjunum, Kanada og Evrópu.", "about.personal": "Utan kóða spila ég á píanó og þróa tölvuleiki.", "about.email": "Netfang",
    "contact.eyebrow": "Hafa samband", "contact.title": "Ertu með verkefni? Tölum saman.", "contact.subtitle": "Ég er laus í fullstack-vörur, API, SaaS-palla, sjálfvirkni og tækniráðgjöf. Svara innan 24-48 klukkustunda.", "contact.email": "Netfang", "contact.linkedin": "LinkedIn", "contact.github": "GitHub", "contact.resume": "Ferilskrá", "contact.downloadCv": "Sækja CV", "contact.location": "Staðsetning", "contact.locationValue": "Santo Domingo, Dóminíska lýðveldið — laus í fjarvinnu á heimsvísu", "contact.name": "Nafn", "contact.namePlaceholder": "Nafnið þitt", "contact.emailPlaceholder": "thu@example.com", "contact.projectDescription": "Lýsing verkefnis", "contact.projectPlaceholder": "Segðu frá kerfinu, API, vörunni eða ráðgjafarþörfinni.", "contact.remote": "Fjarvinnusamningar", "contact.send": "Senda fyrirspurn",
  },
} as const;
